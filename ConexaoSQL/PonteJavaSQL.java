...
public class PonteJavaSQL {
    ...
    public List<PessoaDivida> listarDividasPorPessoa(){
        ...
        while (retorno.next()) {
            ...
            objPessoa.setIdPessoaDivida(retorno.getInt("idDivida"));
            System.out.println("Id Atribuido");
            objPessoa.setNomePessoaDivida(retorno.getString("Nome"));
            System.out.println("Nome Atribuido");
            objPessoa.setValorPessoaDivida(retorno.getDouble("Valor"));
            System.out.println("Valor Atribuido"); 
            objPessoa.setFiliacaoPessoaDivida(retorno.getString("Filiacao"));
            System.out.println("Filiação Atribuida");
            objPessoa.setPrazoDiasPessoaDivida(retorno.getInt("PrazoDevolucao"));
            System.out.println("Prazo Atribuido");
            objPessoa.setDataOperacaoPessoaDivida(retorno.getDate("DataOperacao"));
